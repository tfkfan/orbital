...
public class MatchmakerManagerImpl implements MatchmakerManager {
    ...
    final UniqueQueue<GameRoomJoinEvent> playersQueue = new UniqueQueue<>();
    ...
    void onPlayerWait(GameRoomJoinEvent joinEvent) {
    ...
    private void addPlayerToWait(GatewaySession userSession, JsonObject initialData) {
        onPlayerWait(new GameRoomJoinEvent(userSession, initialData));
    }
